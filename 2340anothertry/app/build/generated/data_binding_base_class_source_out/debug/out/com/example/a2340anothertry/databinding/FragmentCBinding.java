...
public final class FragmentCBinding implements ViewBinding {
  ...
  private FragmentCBinding(@NonNull ConstraintLayout rootView, @NonNull TextView aText,
      @NonNull Button button6, @NonNull EditText description, @NonNull EditText name1,
      @NonNull Button pickDate, @NonNull TextView textView4, @NonNull TextView textView5) {
  ...
  public static FragmentCBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCBinding((ConstraintLayout) rootView, aText, button6, description, name1,
          pickDate, textView4, textView5);
    }
