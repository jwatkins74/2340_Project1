...
public final class FragmentDBinding implements ViewBinding {
  ...
  private FragmentDBinding(@NonNull ConstraintLayout rootView, @NonNull TextView aText,
  ...
  public static FragmentDBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_d, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentDBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDBinding((ConstraintLayout) rootView, aText, button6, description, name1,
