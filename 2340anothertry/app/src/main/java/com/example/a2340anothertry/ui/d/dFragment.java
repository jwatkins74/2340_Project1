...
import com.example.a2340anothertry.databinding.FragmentDBinding;
...
import com.example.a2340anothertry.ui.c.cFragment;
import com.example.a2340anothertry.ui.c.cViewModel;
...
public class dFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        dViewModel dViewModel =
                new ViewModelProvider(this).get(dViewModel.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            boolean booleanDescription = false;
            ...
            public void onClick(View v) {
                ...
                if (booleanName && booleanDate && booleanDescription && booleanTime) {
                    MainActivity.todoList.add(new todos(name.getText().toString(), description.getText().toString(), time, date));

                    NavHostFragment.findNavController(dFragment.this)
                            .navigate(R.id.action_nav_d_to_nav_home);
                } else {
